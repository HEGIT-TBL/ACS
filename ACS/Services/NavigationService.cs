...
namespace ACS.Services
{
    public class NavigationService : INavigationService
    {
        ...
        public bool NavigateDoubleRemoveBackEntryTo(Type pageType, object parameter = null, bool clearNavigation = false)
        {
            if(_frame!=null)
            {
                _frame.Navigated += Frame_Navigated;
                var navigated = NavigateTo( pageType,  parameter ,  clearNavigation );
                return navigated;
            }
            return false;
        }
